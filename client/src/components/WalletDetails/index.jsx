...
export default function WalletDetails() {
    ...
    const action = useMemo(() => (!account ? connect : disconnect), [account, connect, disconnect]);

    const icon = useMemo(() => (!account ? <TbPlugConnectedX size='24' /> : <TbPlugConnected size='24' />), [account]);
