...
export function getFileExtension(type) {
    switch (true) {
        ...
        case !!type.match('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'):
        case !!type.match('application/vnd.openxmlformats-officedocument.presentationml.presentation'):
